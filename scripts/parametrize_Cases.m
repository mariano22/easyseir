...
p0=[ones(1,nchanges+1),cfr*ones(1,nchanges+1)];
p0(1)=0;
%discrete parameters
...
if useRel
  [xb,p]=leasqr(tdata,xdata,p0,@sim_seirdCases,[],[],WT);
else
  [xb,p]=leasqr(tdata,xdata,p0,@sim_seirdCases);
end
%e=zeros(1,2);
display errors
